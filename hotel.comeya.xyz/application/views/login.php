...
<body class="bg-gradient-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="form_acceso" name="form_acceso">
                                        ...
                                        <a href="#" id="btn_ingresar" class="btn btn-primary btn-user btn-block">
                                            Ingresar
                                        </a>
                                        <hr>
    ...
    <!-- Validacion de ajax para validacion del usuario-->
